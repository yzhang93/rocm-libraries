...
#
# Steps:
#   1. Generate a PartialRMS LibraryLogic YAML for the target chip.
...
#
# Usage:
#   tools/test_client_partialrms.sh [--chip CHIP] [--client PATH] [--out-dir DIR]
#
# Arguments:
...
python3 "${TENSILELITE_ROOT}/tools/gen_partialrms_logic.py" \
    --chip "$CHIP" \
    --out-dir "$LOGIC_DIR"

LOGIC_YAML="${LOGIC_DIR}/${CHIP}/Equality/PartialRMS_BF16_TN.yaml"
